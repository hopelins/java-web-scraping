...
public class LinkedInConnectionDetailCircle {
	...
	final static int CRICLE_SIZE=2000;
...
//			driver = crawler.setUpPhantomJSDriver();
		...
		try {
			...
			LinkedInConnectionDetailCircle detailCrawler = new LinkedInConnectionDetailCircle();
...
//					if (connectionInfo.getName().indexOf(begin) == 0 || connectionInfo.getName().indexOf(end) == 0) {
					...
					while (scrollCnt <= 3) {
						try {
							...
							js.executeScript("window.scrollTo(100," + (500 * scrollCnt) + ")");
							scrollCnt++;
...
//				break;
	...
	public static void main(String[] args) {
		...
		//
				...
				LinkedInConnectionDetailCircle process = new LinkedInConnectionDetailCircle();
